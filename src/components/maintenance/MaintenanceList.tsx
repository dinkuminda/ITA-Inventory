    ...
    <div className="space-y-6 animate-in fade-in duration-500">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div className="space-y-1">
          <h2 className="text-2xl font-bold tracking-tight text-foreground">Service & Maintenance</h2>
          <p className="text-sm text-muted-foreground">Track repairs, operational health, and maintenance history.</p>
        </div>
